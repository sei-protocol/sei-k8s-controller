...
var meter = observability.NewMeter("seinetwork")
...
func init() {
	...
	_, err = meter.Float64ObservableGauge(
		"sei.controller.seinetwork.phase",
		metric.WithDescription("Current phase of each SeiNetwork (1=active, 0=inactive)"),
	...
	deploymentReplicas, err = meter.Float64Gauge(
		"sei.controller.seinetwork.replicas",
		metric.WithDescription("Replica counts for each SeiNetwork"),
	)
	if err != nil {
		panic("otel metric init: " + err.Error())
	}
...
func emitGroupPhase(ns, name string, phase seiv1alpha1.SeiNetworkPhase) {
